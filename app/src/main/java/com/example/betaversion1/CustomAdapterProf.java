...
public class CustomAdapterProf extends BaseAdapter {
    Context context;
    String username;
    ...
    public CustomAdapterProf(Context applicationContext, String username,ArrayList<String> book_name,ArrayList<String> ratings
